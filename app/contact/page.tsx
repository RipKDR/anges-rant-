...
import { MailIcon, MusicNoteIcon } from "@/components/Icons";
          ...
          {site.contactEmail ? (
            <>
              ...
              >
                ...
                <p className="mt-3 text-white/60">
                  Press, collaborations, fan mail and rants of your own — all
                  welcome.
                </p>
                <p className="mt-6 font-semibold text-groove-pink transition-colors group-hover:text-groove-orange">
                  Drop us a line →
            ...
            officialStore && (
              <a
                ...
                className="group rounded-3xl border border-white/10 bg-night-soft/60 p-10 transition-all hover:-translate-y-1 hover:border-groove-pink/60 hover:shadow-[0_14px_50px_rgba(255,46,166,0.2)] sm:col-span-2"
              >
                <MusicNoteIcon className="h-10 w-10 text-groove-pink" />
                <h2 className="font-display mt-6 text-3xl text-white">
                  Reach the band
                </h2>
